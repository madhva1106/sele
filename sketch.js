...
losev=loadSound("lose.wav");
winv=loadSound("win.wav");
...
function setup() {
  ...
  vicin=createSprite(400,230);
  vicin.addImage(vacimage);
  vicin.scale=0.5
...
vicin.visible=false;
 ...
 if(score===1 || score===2){
  ...
  if(score>10){
    ...
    coronaG.velocityX=-12;
    corona.frameCount%30
  }
...
function spawncorona(){
  if(score>5){ 
    if(frameCount%60===0){
     ...
     corona.y=Math.round(random(400,300))
